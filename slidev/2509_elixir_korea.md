...
* bulk create notebook with attached node
  + minsub-plato@fdaa:2d:84d0:a7b:469:4024:d4cb:2
* deployed livebook
...
<!--
안녕하세요, Elixir만 가능한 실서버 운영 맛보기라는 제목으로 발표를 하게 된 데브올컴퍼니 개발자 김민섭입니다.\
우리는 대 어그로의 시대를 살아가고 있죠. 넘쳐나는 쇼츠, 하루가 멀다하고 나오는 새로운 AI 툴들.\
일론 머스크의 자율주행 레벨 4와 샘 알트먼의 AGI 허풍은 이제 지겨울 정도입니다.\
...
Elixir와 Livebook 없이 오늘 보여드릴 워크플로우를 따라하기가 쉽지는 않을거거든요.
-->
...
이거 수동으로 입력하기는 너무 힘든데 데이터 마이그레이션이 가능할까요?"
-->
...
<!--
이상적인 방법은 스프레드시트 파일 업로드 기능을 개발하는 것이겠죠.\
...
<!--
하지만 스프레드시트 파일 업로드 기능을 위해 UI를 개발하는 데에는 시간이 많이 소요됩니다.\
실패 시 수백줄의 파일 중 어느부분이 어떻게 틀렸는지 적절하게 피드백을 주는 것은 복잡하죠.\
...
## 스프레드시트 파일을 처리하는 로직만 만들어서 직접 처리

<!--
그래서 이메일로 파일을 받아 직접 처리하기로 합니다.\
