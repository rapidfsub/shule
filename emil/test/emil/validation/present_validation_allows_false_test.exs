...
defmodule ThisTest do
  ...
  test "builtin present validation only checks for nil" do
    assert {:error, _reason} = Ash.Changeset.for_create(ThisTest.Obj, :create) |> Ash.create()

    params = %{is_admin: nil}

    assert {:error, _reason} =
             Ash.Changeset.for_create(ThisTest.Obj, :create, params) |> Ash.create()
    ...
    assert Ash.Changeset.for_create(ThisTest.Obj, :create, params) |> Ash.create!()
